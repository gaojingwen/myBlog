...
![img](https://segmentfault.com/img/bV9GOl?w=630&h=179/view)

## 二、检查图像是否加载

有时为了继续脚本，你可能需要检查图像是否全部加载完毕。

![img](https://segmentfault.com/img/bV9GOp?w=461&h=77/view)
...
![img](https://segmentfault.com/img/bV9GOJ?w=787&h=127/view)

## 四、悬停切换

当用户鼠标悬停在可点击的元素上时，可添加类到元素中，反之则移除类。	

![img](https://segmentfault.com/img/bV9LXp?w=370&h=129/view)

只需要添加必要的 CSS 即可。更简单的方法是使用 **toggleClass()** 方法。

![img](https://segmentfault.com/img/bV9MaN?w=367&h=78/view)

## 五、淡入淡出/显示隐藏

![淡入淡出/显示隐藏](https://segmentfault.com/img/bV9M2B?w=380&h=201)
...
```
var getLocalTime = function (nS, format) {
...
![img](https://segmentfault.com/img/bV9M44?w=643&h=78/view)

## 三十一、链式插件调用

jQuery 允许“链式”插件的方法调用，以减轻反复查询 DOM 并创建多个 jQuery 对象的过程。

![img](https://segmentfault.com/img/bV9M5r?w=271&h=77/view)

通过使用链式，可以改善

![img](https://segmentfault.com/img/bV9M5E?w=159&h=102/view)

还有一种方法是在（**前缀$**）变量中高速缓存元素

![img](https://segmentfault.com/img/bV9M50?w=259&h=98/view)
